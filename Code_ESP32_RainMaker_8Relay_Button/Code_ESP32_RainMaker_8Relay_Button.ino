/**********************************************************************************
 *  TITLE: ESP RainMaker + Manual Button control 8 Relays using ESP32 (Real time feedback + no WiFi control)
...
const char *service_name = "PROV_syedamirali1841";
const char *pop = "01817807594";

// define the Device Names
char deviceName_1[] = "Room Light";
char deviceName_2[] = "Table Lamp";
char deviceName_3[] = "Outdoor Light";
char deviceName_4[] = "Bathroom Light";
char deviceName_5[] = "Fan";
char deviceName_6[] = "Table Fan";
char deviceName_7[] = "Computer";
char deviceName_8[] = "Night Lamp";
...
void setup()
{
    ...
    Node my_node;    
    my_node = RMaker.initNode("ESP32_Rainmaker_Automation");
